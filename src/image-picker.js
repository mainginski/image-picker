...
(function() {
  ...
  jQuery.fn.extend({
    imagepicker: function(opts) {
      ...
      return this.each(function() {
        ...
        jQuery(".image_picker_selector .img-responsive.hide").each(function() {
  ...
  ImagePicker = (function() {
    ...
    ImagePicker.prototype.build_and_append_picker = function() {
	  ...
	  if(this.opts.show_numbers === true && this.opts.limit > 0){
		  this.show_atual_numbers();
	  }
    ...
    ImagePicker.prototype.create_picker = function() {
      this.picker  = jQuery("<div class='thumbnails image_picker_selector row'></div>");
	  if(this.opts.show_numbers === true && this.opts.limit > 0){
	    numbers = jQuery("<div class='"+this.opts.class_numbers+"'></div>");
		this.picker.prepend(numbers);
	  }
      this.picker_options = [];
	...
	ImagePicker.prototype.show_atual_numbers = function() {
		return $("."+this.opts.class_numbers).html(this.selected_values().length  + "/" + this.opts.limit);
    };
    ...
    ImagePicker.prototype.toggle = function(imagepicker_option) {
      ...
      if (this.multiple) {
        if (__indexOf.call(this.selected_values(), selected_value) >= 0) {
          ...
          if ((this.opts.limit != null) && this.selected_values().length+1 > this.opts.limit) {
			...
			if(this.opts.show_numbers === true && this.opts.limit > 0){
				var x = 0;
				var $numbers = $("."+this.opts.class_numbers);
				$numbers.toggleClass("text-danger");
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, thumbnail;
      this.node = jQuery("<div class='col-xs-12 col-sm-6 col-md-4'/>");
      image = jQuery("<img class='img-responsive hide'/>");
